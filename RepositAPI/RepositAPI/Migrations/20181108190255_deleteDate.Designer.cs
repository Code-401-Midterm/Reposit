...
namespace RepositAPI.Migrations
{
    ...
    [Migration("20181108190255_deleteDate")]
            ...
            modelBuilder.Entity("RepositAPI.Models.Snippet", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, AuthorID = 1, CodeBody = "Console.WriteLine(\"Hello World!\")", Language = 8, Notes = "This is cool.", Title = "Hello World console writeline" },
                        new { ID = 2, AuthorID = 2, CodeBody = "Print(\"Hello World!\")", Language = 4, Notes = "This is cooler", Title = "Hello World python" },
...
}", Language = 0, Notes = "Use array map method to take in an array and return a modified array. The returned array should containing the result of raising 2 to the power of the original input element.", Title = "Array.Prototype.Map()" },
    ...
    client.query(SQL, values, (err, serverRes) => {
        if(err){
            ...
            res.redirect(`/patient/${serverRes.rows[0].id}?added=true`);
                        ...
                        new { ID = 10, AuthorID = 3, CodeBody = "SELECT * FROM myTable", Language = 11, Notes = "Simple sql query. * means everything!", Title = "SQL" }
                    );
                });
